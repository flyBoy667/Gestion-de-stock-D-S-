                    ...
                    function recolter() {
                        document.getElementById("formulaire").request({
                            onComplete: function (transport) {
                                ...
                                let idFournisseur = document.getElementById("ref_fournisseur").value

                                document.getElementById("valider").disabled = idFournisseur <= 0;
                                ...
                                switch (document.getElementById('param').value) {
                                    ...
                                    case 'creer_fournisseur':
                                        ...
                                        const nom_fournisseur = document.getElementById('nom_fournisseur').value;
                                        const prenom_fournisseur = document.getElementById('prenom_fournisseur').value;

                                        if (societe === " ") {
                                            errors.push("Veuillez sélectionner la societe.");
                                        }

                                        if (nom_fournisseur === "") {
                                            errors.push("Veuillez saisir le nom du fournisseur.");
                                        }

                                        if (prenom_fournisseur === "") {
                                            errors.push("Veuillez saisir le prénom du fournisseur.");
                                        }
                                        ...
                                        const rep = transport.responseText;

                                        if (rep === "nok")
                                            alert("Le fournisseur existe déjà");
                                        else {
                                            const liste = document.getElementById("ref_fournisseur");
                ...
                <form id="formulaire" name="formulaire" method="post" action="action/add_achat_fournisseur.php">
                    <div class="titre_h1" style="height:350px;">
                        ...
                        <div style="width:35%;height:50px;float:left;font-size:16px;font-weight:bold;text-align:left;">
                            <input type="button" id="creer_fournisseur" name="creer_fournisseur"
                        ...
                        <div style="width:15%;height:55px;float:left;font-size:16px;font-weight:bold;text-align:left;">
                            ...
                            <select id="ref_fournisseur" name="ref_fournisseur"
                                ...
                                <?php
                                $requete = "SELECT ref_fournisseur FROM fournisseur ORDER BY ref_fournisseur;";
                                $retours = mysqli_query($liaison, $requete);
                                while ($retour = mysqli_fetch_array($retours)) {
                                    echo "<option value='" . $retour["ref_fournisseur"] . "'>" . $retour["ref_fournisseur"] . "</option>";
                                }
                                ?>
                            </select>
                        </div>
